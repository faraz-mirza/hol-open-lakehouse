...
STORED AS TEXTFILE LOCATION 's3a://goes-se-sandbox/data/user/${cdp_env_bucket}/flights' tblproperties("skip.header.line.count"="1");
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n'
STORED AS TEXTFILE LOCATION 's3a://goes-se-sandbox/data/user/${cdp_env_bucket}/planes' tblproperties("skip.header.line.count"="1");
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n'
STORED AS TEXTFILE LOCATION 's3a://goes-se-sandbox/data/user/${cdp_env_bucket}/airlines' tblproperties("skip.header.line.count"="1");
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n'
STORED AS TEXTFILE LOCATION 's3a://goes-se-sandbox/data/user/${cdp_env_bucket}/airports' tblproperties("skip.header.line.count"="1");
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' 
STORED AS TEXTFILE LOCATION 's3a://goes-se-sandbox/data/user/${cdp_env_bucket}/unique_tickets' 
